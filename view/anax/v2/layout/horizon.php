...
<div class="wrap-header">
    ...
    <?php if (regionHasContent("navbar")) : ?>
        <div class="outer-wrap outer-wrap-navbar container-fluid">
    ...
    <?php if (regionHasContent("header") || regionHasContent("header-col-1")) : ?>
        <div class="container header">
            <div class="inner-wrap inner-wrap-header">
                <div class="row">
                    <header class="region-header col-md" role="banner">
                        <!-- header -->
...
<div class="outer-wrap outer-wrap-breadcrumb container">
...
<div class="super-main-wrap container">
    <!-- flash message -->
    <?php if (regionHasContent("flash-message")) : ?>
        <div class="outer-wrap outer-wrap-flash-message container">
    ...
    <?php if (regionHasContent("columns-above")) : ?>
        <div class="outer-wrap outer-wrap-columns-above container-fluid">
    ...
    <!-- main -->
    <div class="outer-wrap outer-wrap-main container-fluid">
    ...
    <?php if (regionHasContent("after-main")) : ?>
        <div class="outer-wrap outer-wrap-after-main container-fluid">
    ...
    <?php if (regionHasContent("columns-below")) : ?>
        <div class="outer-wrap outer-wrap-columns-below container-fluid">
...
<div class="outer-wrap outer-wrap-footer container-fluid" role="contentinfo">
...
<!-- copyright -->
<?php if (regionHasContent("copyright")) : ?>
<div class="outer-wrap outer-wrap-footer container-fluid" role="contentinfo">
    <div class="inner-wrap inner-wrap-footer">
        <div class="row">
                <?php renderRegion("copyright") ?>
        </div>
    </div>
</div>
<?php endif; ?>
